...
def test_resources_are_pack_specific_read_only_and_legacy_safe(tmp_path: Path) -> None:
    ...
    assert tools == {"list_packs", "get_staleness", "load_pack", "get_schema", "entity_lookup", "get_communities", "get_entity", "semantic_search", "graph_query", "traverse_relations", "find_path", "claims_for", "find_contradictions", "compare_claims", "list_methods", "get_method", "trace_method", "list_method_gaps"}
