...
import { Home, Download, CheckSquare, Package, FolderOpen, Plug, Merge, Users, Network, BookOpen, Cpu, Settings, Layers } from "lucide-react";
...
const NAV = [
  ...
  { to: "/claims", icon: Layers, label: "주장" },
